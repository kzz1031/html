        ...
        <el-menu :default-openeds="['1', '3']">
          <el-sub-menu index="1">
            <template #title>
              ...
              <el-menu-item index="1-1" @click="jumptoMain()">主界面</el-menu-item>
              <el-menu-item index="1-2" @click="jumptoHistory()">历史记录查询</el-menu-item>
              <el-menu-item index="1-3" @click="jumptoCollection()">收藏</el-menu-item>
          </el-sub-menu>
          <el-sub-menu index="2">
            <template #title>
              <el-icon><icon-menu /></el-icon><el-text size="large">设置</el-text>
            </template>
